...
workspace_name = "genterist-lab-stu" # PLACEHOLDER
subscription_id = "0f780988-6c1e-4d1d-8aa9-ae95e36fca65" # PLACEHOLDER
resource_group = "genterist-rg" # PLACEHOLDER
experiment_name = "TCN-4-ColdStart-Task1" # PLACEHOLDER
iteration = "0"  # PLACEHOLDER
run_id = "AutoML_6ee6b800-98e9-40e8-9b68-65e6ab819b1e_0"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':True,'enable_stack_ensembling':False,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'save_mlflow':True,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowDNN','TensorFlowLinearRegressor'],'whitelist_models':['Arimax','Prophet','AutoArima','ExponentialSmoothing'],'compute_target':'DS12','enable_dnn':False,'enable_code_generation':True,'experiment_exit_score':None,'experiment_timeout_minutes':600,'featurization':{'_blocked_transformers':[],'_column_purposes':{'Average':'Numeric'},'_transformer_params':{'Imputer':[]},'_drop_columns':['Minimum','Maximum']},'hyperdrive_config':None,'grain_column_names':None,'is_timeseries':True,'iteration_timeout_minutes':600,'max_concurrent_iterations':1,'metric_operation':'minimize','model_explainability':True,'n_cross_validations':'auto','name':'TCN-4-ColdStart-Task1','path':'./sample_projects/TCN-4-ColdStart-Task1','primary_metric':'normalized_root_mean_squared_error','region':'eastus2','resource_group':'genterist-rg','subscription_id':'0f780988-6c1e-4d1d-8aa9-ae95e36fca65','task_type':'regression','validation_size':None,'test_size':None,'vm_type':'STANDARD_DS12_V2','workspace_name':'genterist-lab-stu','label_column_name':'Func_ID','max_horizon':200,'country_or_region':None,'cv_step_size':200,'freq':None,'target_aggregation_function':None,'target_lags':None,'target_rolling_window_size':None,'time_column_name':'Func_index','enable_batch_run':True,'dataset_id':'9006683f-792c-4b7e-b402-d2dfab8107d0'} # PLACEHOLDER
pipeline_spec = "{\"objects\":[{\"spec_class\":\"timeseries\",\"class_name\":\"ExponentialSmoothing\",\"module\":\"automl.client.core.common.forecasting_models\",\"param_args\":[],\"param_kwargs\":{},\"prepared_kwargs\":{}}],\"pipeline_id\":\"__AutoML_ExponentialSmoothing__\"}" # PLACEHOLDER
pipeline_id = "__AutoML_ExponentialSmoothing__" # PLACEHOLDER
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"9006683f-792c-4b7e-b402-d2dfab8107d0\"}}" # PLACEHOLDER
